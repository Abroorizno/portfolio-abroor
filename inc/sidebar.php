<div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text fs-5 menu-text fw-bolder">Dashboard</span>
    </a>
...
<ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
        <span class="menu-header-text">FRONT SERVICES</span>
    </li>
    ...
    <li class="menu-item">
        <a href="?page=education" class="menu-link">
    ...
    <li class="menu-item">
        <a href="?page=resume" class="menu-link">
            <i class="menu-icon tf-icons bx bx-detail"></i>
            <div data-i18n="Analytics">Resume</div>
        </a>
    </li>


    <li class="menu-item">
        <a href="?page=skill" class="menu-link">
    ...
    <li class="menu-item">
        <a href="?page=messages" class="menu-link">
            <i class="menu-icon tf-icons bi bi-envelope-arrow-down"></i>
