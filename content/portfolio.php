<?php
$sqlGet = mysqli_query($conn, "SELECT * FROM portfolio ORDER BY id DESC");
$result = mysqli_fetch_all($sqlGet, MYSQLI_ASSOC);

// Cek apakah folder assets/uploads ada
$uploadDir = "../assets/uploads/portfolio/";
if (!is_dir($uploadDir)) {
...
if (isset($_POST['simpan'])) {
    ...
    if (move_uploaded_file($photo['tmp_name'], $fillPath)) {
        ...
        // Simpan ke database
        $sqlInsert = mysqli_query($conn, "INSERT INTO portfolio (nama, photo, description) VALUES ('$nama', '$fillName', '$desc')");

        if ($sqlInsert) {
            echo "Data berhasil dimasukkan ke database.";
            echo "<script>window.location.href='?page=portfolio&add=success';</script>";
            exit();
        } else {
...
if (isset($_GET['id'])) {
    ...
    $sqlGet = mysqli_query($conn, "SELECT * FROM portfolio WHERE id = '$id'");
...
if (isset($_POST['edit'])) {
    ...
    $sql = mysqli_query($conn, "UPDATE portfolio SET nama = '$nama', photo = '$photoName', description = '$desc' WHERE id = '$id'");

    if ($sql) {
        echo "<script>window.location.href='?page=portfolio&update=success';</script>";
    } else {
        echo "<script>alert('DATA GAGAL DI UBAH')</script>" . mysqli_error($conn);
        header("Location: add_edit_blog.php?portfolio=gagal");
    }
}
...
if (isset($_GET['delete'])) {
    ...
    $sqlDel = mysqli_query($conn, "DELETE FROM portfolio WHERE id = '$id'");
    ...
    if ($sqlDel) {
        ...
        echo "<script>window.location.href='?page=portfolio&notif=success';</script>";
    } else {
                ...
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-header">
                            <h5 class="card-title text-primary">Portfolio Data</h5>
                            <!-- ALERT ERROR -->
                            <?php if (isset($_GET['portfolio'])) : ?>
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    <i class="bx bx-bell me-2"></i>
                                    <strong>Portfolio Has Added!</strong>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalCenterTitle">Portfolio Add</h5>
                                                <button
                                                    type="button"
                                                    class="btn-close"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="nameWithTitle" class="form-label">Name of Project</label>
                                                    </div>
                                                    <div class="col-sm-12">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table">
                                        ...
                                        ?>
                                            <tbody>
                                                <td><?php echo $no++ . '.' ?></td>
                                                <td><img src="../assets/uploads/portfolio/<?= $row['photo'] ?> " alt="" width="200"></td>
                                                <td><?= $row['nama'] ?></td>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalCenterTitle">Portfolio Edit</h5>
                                                                <button
                                                                    type="button"
                                                                    class="btn-close"
                                                                    data-bs-dismiss="modal"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        <img src="../assets//uploads/service/<?= $row['photo']; ?>" alt="" width="100">
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <div class="col">
