...
<head>
    ...
    <title>myPorto Dashboard</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../assets/uploads/apple-touch-icon.png" />
    ...
    <link rel="stylesheet" href="../assets/front-end/vendor/libs/apex-charts/apex-charts.css" />
...
<body>
    ...
    <!-- Vendors JS -->
    <script src="../assets/front-end/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="../assets/front-end/js/main.js"></script>

    <!-- Page JS -->
    <script src="../assets/front-end/js/dashboards-analytics.js"></script>
